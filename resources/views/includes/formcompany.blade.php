    ...
    <div class="noscroll">
        <div class="inside__scroll">
            <div class="p-md-5 pt-5 pb-5 pr-2 pl-2">
                <h5 class="text-light text-center">Добавить в список компанию</h5>
                <p class="text-light">Все сообщения перед публикацией проходят модерацию. Старайтесь писать лаконично.</p>
                <form class="mt-5" method="POST" action="{{ route('add.blacklist', [ 'info' => 'company' ]) }}">
                    
                @csrf
                
                    <div class="form-group">
                        <label class="color-main">Название компании</label>
                        <input type="text" name="name" class="d-block form-control border-main bg-dark placeholder-main text-light" placeholder="Название компании" required>
                    </div>
                    <div class="form-group">
